 ...
 *   entirety and paste it here, changing the prefix from theme_ to xmas_.
 *   For example:
 *
 *     original: theme_breadcrumb()
 *     theme override: xmas_breadcrumb()
 *
 *   where xmas is the name of your sub-theme. For example, the
 ...
 */
function xmas_theme(&$existing, $type, $theme, $path) {
...
function xmas_preprocess(&$vars, $hook) {
 ...
 */
/* -- Delete this line if you want to use this function
function xmas_preprocess_block(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
